...
class IslamicAIAgent:
    ...
    def setup_agent(self):
        ...
        self.toolkit.register_tool_function(get_quran_verse)
        self.toolkit.register_tool_function(get_hadith)
        self.toolkit.register_tool_function(get_dua)
        self.toolkit.register_tool_function(get_prayer_times)
        self.toolkit.register_tool_function(get_qibla_direction)
        self.toolkit.register_tool_function(get_hijri_date)
        self.toolkit.register_tool_function(get_islamic_guidance)
        self.toolkit.register_tool_function(search_islamic_content)
        self.toolkit.register_tool_function(get_daily_islamic_content)
        self.toolkit.register_tool_function(get_surah_info)
