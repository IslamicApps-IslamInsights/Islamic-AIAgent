...
def get_trending_topics_api():
    ...
    try:
        trending = [
            {'topic': 'Ramadan Prep', 'count': 1250, 'trend': 'up'},
            {'topic': 'Zakat Calculation', 'count': 980, 'trend': 'up'},
            {'topic': 'Morning Adhkar', 'count': 850, 'trend': 'stable'},
            {'topic': 'Patience in Islam', 'count': 720, 'trend': 'down'}
        ]
