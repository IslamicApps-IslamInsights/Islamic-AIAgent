...
def chat():
    ...
    try:
        ...
        # Determine the best tool based on message content
...
def multi_chat():
    ...
    try:
        ...
        if specialist == 'auto':
            specialist_name, response = auto_route_message(message)
        else:
            specialist_name, response = route_to_specialist(message, specialist)
